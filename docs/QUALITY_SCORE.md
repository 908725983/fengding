...
- 最近审计：2026-08-12
- 当前阶段：`INV-001` 已完成验收并归档；下一切片为 `ORD-001`，尚未开工。
...
| 已知人工决策门 | 82 | `DEC-INV-001～013` 已确认并在 `INV-001` 实现；其余 open 决策继续只阻塞各自切片 |
| 当前业务 active plan | 0 | `INV-001` 已归档；`ORD-001` 尚未建立 specification 计划 |

`INV-001` 的 `DEC-INV-001～013` 已全部实现并有验证证据；`ORD-001` 与 `PRD-006` 保持 source-only。
