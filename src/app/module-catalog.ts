...
export const businessModules: BusinessModule[] = [
  ...
  { key: 'orders', label: '订单', shortLabel: '订', icon: '▤', description: '客户订单、退单、差异与销售出库', path: '/orders', spec: 'docs/product-specs/orders.md', status: 'planned' },
  ...
  { key: 'procurement', label: '采购', shortLabel: '采', icon: '⌑', description: '补货、采购、供应商与采购统计', path: '/procurement', spec: 'docs/product-specs/procurement.md', status: 'planned' },
  { key: 'inventory', label: '库存', shortLabel: '库', icon: '▣', description: '仓库、库存、盘点、分拣与配送', path: '/inventory', spec: 'docs/product-specs/inventory.md', status: 'planned' },
  ...
  { key: 'finance', label: '资金', shortLabel: '资', icon: '¥', description: '应收应付、核销、收付款与账户', path: '/finance', spec: 'docs/product-specs/finance.md', status: 'planned' },
