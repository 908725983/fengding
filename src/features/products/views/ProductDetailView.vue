...
<template>
  <section class="detail-page">
    ...
    <template v-else>
      ...
      <nav class="tabs"><button :class="{active:activeTab==='description'}" type="button" @click="activeTab='description'">商品描述</button><button :class="{active:activeTab==='authorization'}" type="button" @click="activeTab='authorization'">商品授权</button><span>等级/客户价格 · PRD-002 价格工作台</span><span>供应商价格 · 规划中</span><span>订货设置/关联商品 · 规划中</span></nav>
