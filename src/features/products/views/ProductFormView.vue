...
import type { Product, ProductDraft, ProductMedia, ProductReference, ProductSkuDraft, RichTextDocument } from '../types'
...
type CategoryRow = { category: ProductReference; depth: number; hasChildren: boolean }
