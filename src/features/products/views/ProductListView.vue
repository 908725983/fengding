...
const { result, references, loading, error, referenceError, isEmpty, scenario, query, canWrite } = storeToRefs(store)
...
function showImport(): void { window.alert('原型模拟：导入使用 UTF-8 CSV 预览与整批校验，完整入口将在本切片表单完成后启用。') }
