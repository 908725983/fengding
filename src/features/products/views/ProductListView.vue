...
<template>
  <section class="product-page" aria-labelledby="product-title">
    ...
    <div class="legacy-product-subnav" aria-hidden="true">价格管理 · PRD-002 商品授权 · PRD-003 铺货与模板 · PRD-004 辅助资料 · PRD-005</div>
