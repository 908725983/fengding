...
<template>
  <section class="product-page" aria-labelledby="product-title">
    ...
    <div class="product-subnav"><strong>商品管理</strong><RouterLink to="/products/prices/level-adjustments">价格管理 · PRD-002</RouterLink><span>商品授权 · PRD-003 规划中</span><span>辅助资料 · PRD-005 规划中</span></div>
